...
<table border="0" width=40% height=300px align="center">
	<form name="ligB" method="past" action="/gyu/purchase.jsp">
		<tr>
			<td>
				<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFHs9f06HXxkl4_8IlxGzOl_lice6rk0yPrg&usqp=CAU"
